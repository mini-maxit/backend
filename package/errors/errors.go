...
var ErrContestExists = fmt.Errorf("contest with this title already exists")
var ErrContestNotFound = fmt.Errorf("contest not found")
var ErrInvalidTimeRange = fmt.Errorf("end time must be after start time")
