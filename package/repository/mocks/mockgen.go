...
// Source: ./package/repository (interfaces: ContestRepository,GroupRepository,SubmissionRepository,TaskRepository,UserRepository,LanguageRepository,TestCaseRepository,QueueMessageRepository,SubmissionResultRepository,TestRepository,File)
//
// Generated by this command:
//
//	mockgen -destination package/repository/mocks/mockgen.go ./package/repository ContestRepository,GroupRepository,SubmissionRepository,TaskRepository,UserRepository,LanguageRepository,TestCaseRepository,QueueMessageRepository,SubmissionResultRepository,TestRepository,File
//
...
func (m *MockContestRepository) GetAvailableTasksForContest(tx *gorm.DB, contestID int64) ([]models.Task, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAvailableTasksForContest", tx, contestID)
...
func (mr *MockContestRepositoryMockRecorder) GetAvailableTasksForContest(tx, contestID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAvailableTasksForContest", reflect.TypeOf((*MockContestRepository)(nil).GetAvailableTasksForContest), tx, contestID)
}
