...
// Source: ./package/repository (interfaces: SubmissionRepository,GroupRepository,TestCaseRepository,LanguageRepository,QueueMessageRepository,SubmissionResultRepository,TaskRepository,TestRepository,UserRepository,File)
//
// Generated by this command:
//
//	mockgen -destination package/repository/mocks/mockgen.go ./package/repository SubmissionRepository,GroupRepository,TestCaseRepository,LanguageRepository,QueueMessageRepository,SubmissionResultRepository,TaskRepository,TestRepository,UserRepository,File
//
