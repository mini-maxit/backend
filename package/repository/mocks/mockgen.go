...
// Source: ./package/repository (interfaces: SubmissionRepository,GroupRepository,InputOutputRepository,LanguageRepository,QueueMessageRepository,SessionRepository,SubmissionResultRepository,TaskRepository,TestRepository,UserRepository)
//
// Generated by this command:
//
//	mockgen -destination package/repository/mocks/mockgen.go ./package/repository SubmissionRepository,GroupRepository,InputOutputRepository,LanguageRepository,QueueMessageRepository,SessionRepository,SubmissionResultRepository,TaskRepository,TestRepository,UserRepository
//
...
// Create mocks base method.
func (m *MockSessionRepository) Create(tx *gorm.DB, session *models.Session) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", tx, session)
	ret0, _ := ret[0].(error)
	return ret0
}

// Create indicates an expected call of Create.
func (mr *MockSessionRepositoryMockRecorder) Create(tx, session any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockSessionRepository)(nil).Create), tx, session)
}

// Delete mocks base method.
func (m *MockSessionRepository) Delete(tx *gorm.DB, sessionID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", tx, sessionID)
	ret0, _ := ret[0].(error)
	return ret0
}

// Delete indicates an expected call of Delete.
func (mr *MockSessionRepositoryMockRecorder) Delete(tx, sessionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockSessionRepository)(nil).Delete), tx, sessionID)
}

// Get mocks base method.
func (m *MockSessionRepository) Get(tx *gorm.DB, sessionID string) (*models.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", tx, sessionID)
...
// Get indicates an expected call of Get.
func (mr *MockSessionRepositoryMockRecorder) Get(tx, sessionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockSessionRepository)(nil).Get), tx, sessionID)
}

// GetByUserID mocks base method.
func (m *MockSessionRepository) GetByUserID(tx *gorm.DB, userID int64) (*models.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByUserID", tx, userID)
	ret0, _ := ret[0].(*models.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSessionRepositoryMockRecorder) GetByUserID(tx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByUserID", reflect.TypeOf((*MockSessionRepository)(nil).GetByUserID), tx, userID)
}
