...
type AuthService interface {
	...
	Login(tx database.Database, userLogin schemas.UserLoginRequest) (*schemas.JWTTokens, error)
	...
	Register(tx database.Database, userRegister schemas.UserRegisterRequest) (*schemas.JWTTokens, error)

	// RefreshTokens refreshes JWT tokens using a valid refresh token
	RefreshTokens(tx database.Database, refreshRequest schemas.RefreshTokenRequest) (*schemas.JWTTokens, error)
}
...
func (as *authService) Login(tx database.Database, userLogin schemas.UserLoginRequest) (*schemas.JWTTokens, error) {
...
func (as *authService) Register(tx database.Database, userRegister schemas.UserRegisterRequest) (*schemas.JWTTokens, error) {
