...
func (m *MockContestService) GetTasksForContest(tx *gorm.DB, currentUser schemas.User, contestID int64, taskNameFilter string) ([]schemas.TaskWithContestStats, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTasksForContest", tx, currentUser, contestID, taskNameFilter)
...
func (mr *MockContestServiceMockRecorder) GetTasksForContest(tx, currentUser, contestID, taskNameFilter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTasksForContest", reflect.TypeOf((*MockContestService)(nil).GetTasksForContest), tx, currentUser, contestID, taskNameFilter)
}
